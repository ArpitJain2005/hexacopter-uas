...
plot_telemetry.py
-----------------
Reads a CSV flight log generated by telemetry_logger.py
and produces plots of altitude, attitude, battery, and GPS track.

Usage:
    python plot_telemetry.py --log flight_log_20250715_143022.csv
